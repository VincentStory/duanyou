 ...
 * 标签fragment的适配器
 */
public class MainContentAdapter2 extends CommonAdapter<DyContextsBean> {
    ...
    public MainContentAdapter2(Context context, List<DyContextsBean> mDatas, int itemLayoutId) {
        super(context, mDatas, itemLayoutId);
    }

    @Override
    public void convert(ViewHolder helper, final DyContextsBean item) {
