 ...
 * 标签fragment的适配器
 */
public class MainContentAdapter2 extends CommonAdapter<GetContentResponse2.DyContextsBean> {
    ...
    public MainContentAdapter2(Context context, List<GetContentResponse2.DyContextsBean> mDatas, int itemLayoutId) {
        super(context, mDatas, itemLayoutId);
    }

    @Override
    public void convert(ViewHolder helper, final GetContentResponse2.DyContextsBean item) {
     ...
     * @param remark
     */
    public void userOperation(String type, String operator, String remark, GetContentResponse2.DyContextsBean item, final GetContentResult result) {
    ...
    public interface OnItemClickListener {
        ...
        void comment(GetContentResponse2.DyContextsBean bean);

        void share(GetContentResponse2.DyContextsBean bean);
    }
