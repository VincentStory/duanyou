...
public final class ImageUtils {
    ...
    public static int[] reCalculateImage(View imageView, int picWidth, int picHeight, int imgWidth) {
    ...
    public static int[] reCalculateJzVideo(JZVideoPlayerStandard video, int videoWidth, int videoHeight, int imgWidth) {
